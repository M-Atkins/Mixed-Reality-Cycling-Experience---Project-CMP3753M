...
public class BleTest : MonoBehaviour
{
    ...
    string serviceUuid = "{9A48ECBA-2E92-082F-C079-9E75AAE428B1}";
    string[] characteristicUuids = {
         "{00002713-0000-1000-8000-00805f9b34fb}"      // CUUID 1
    ...
    public int remoteAngle, lastRemoteAngle;
    ...
    void Start()
    {
        ...
        //Or activate button.
        //ButtonStartScan.onClick?.Invoke();




        //ButtonEstablishConnection.onClick?.Invoke();
        //Debug.Log("call passed");
    ...
    {
        Debug.Log("STARTCONHANDLERWASCALLED!!!!!!");
    ...
    void ConnectBleDevice()
    {
        ...
        if (ble.isConnected)
            Debug.Log("SUCCEEDED");
            Debug.Log("I'm Connected to: " + targetDeviceName);
    }
